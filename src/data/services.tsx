...
// Helper function to optimize all images
const optimizeImages = (urls: string[]) => urls.map(url => CloudinaryPresets.card(url));
...
export const servicesData: Service[] = [
  {
    ...
    imageUrl: CloudinaryPresets.card('https://res.cloudinary.com/djqiqpilh/image/upload/v1762164044/WhatsApp_Image_2025-11-01_at_17.54.36_uzgh07.jpg'),
  ...
  },
  {
    ...
    imageUrl: CloudinaryPresets.card('https://res.cloudinary.com/djqiqpilh/image/upload/v1760452357/Captura_de_pantalla_2025-10-14_a_las_16.32.23_vjh260.png'),
    imageAlt: 'Páginas Web',
    imagesDownload: optimizeImages([
  ...
  },
  {
    ...
    imageUrl: CloudinaryPresets.card('https://res.cloudinary.com/djqiqpilh/image/upload/v1762117716/WhatsApp_Image_2025-11-02_at_22.01.58_z6fbyd.jpg'),
